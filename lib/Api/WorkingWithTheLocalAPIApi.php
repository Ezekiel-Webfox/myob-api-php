...
/**
 * WorkingWithTheLocalAPIApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class WorkingWithTheLocalAPIApi
{
    /**
     * @var ClientInterface
     */
...
/**
    ...
    /**
     * Operation accountrightGet
     *
     * Working over a network
     *
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     * @param  string $x_myobapi_cftoken Base64Encode(username:password) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountrightGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function accountrightGet($x_myobapi_version = null, $x_myobapi_cftoken = null, string $contentType = self::contentTypes['accountrightGet'][0])
    {
        $this->accountrightGetWithHttpInfo($x_myobapi_version, $x_myobapi_cftoken, $contentType);
    }

    /**
     * Operation accountrightGetWithHttpInfo
     *
     * Working over a network
     *
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function accountrightGetWithHttpInfo($x_myobapi_version = null, $x_myobapi_cftoken = null, string $contentType = self::contentTypes['accountrightGet'][0])
    {
        $request = $this->accountrightGetRequest($x_myobapi_version, $x_myobapi_cftoken, $contentType);
    ...
    /**
     * Operation accountrightGetAsync
     *
     * Working over a network
     *
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function accountrightGetAsync($x_myobapi_version = null, $x_myobapi_cftoken = null, string $contentType = self::contentTypes['accountrightGet'][0])
    {
        return $this->accountrightGetAsyncWithHttpInfo($x_myobapi_version, $x_myobapi_cftoken, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountrightGetAsyncWithHttpInfo
     *
     * Working over a network
     *
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountrightGetAsyncWithHttpInfo($x_myobapi_version = null, $x_myobapi_cftoken = null, string $contentType = self::contentTypes['accountrightGet'][0])
    {
        $returnType = '';
        $request = $this->accountrightGetRequest($x_myobapi_version, $x_myobapi_cftoken, $contentType);
    ...
    /**
     * Create request for operation 'accountrightGet'
     *
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     * @param  string $x_myobapi_cftoken Base64Encode(username:password) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountrightGet'] to see the possible values for this operation
     ...
     */
    public function accountrightGetRequest($x_myobapi_version = null, $x_myobapi_cftoken = null, string $contentType = self::contentTypes['accountrightGet'][0])
    {
        ...
        // header params
        if ($x_myobapi_cftoken !== null) {
            $headerParams['x-myobapi-cftoken'] = ObjectSerializer::toHeaderValue($x_myobapi_cftoken);
        }
