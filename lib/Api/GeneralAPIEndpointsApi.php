...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function companyFileIdGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGet'][0])
    {
        list($response) = $this->companyFileIdGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdGetWithHttpInfo
     *
     * Get the details of one specific company file
     *
     ...
     */
    public function companyFileIdGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGet'][0])
    {
        $request = $this->companyFileIdGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Operation companyFileIdGetAsync
     *
     * Get the details of one specific company file
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGet'][0])
    {
        return $this->companyFileIdGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdGetAsyncWithHttpInfo
     *
     * Get the details of one specific company file
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (optional)
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function companyFileIdGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGet'][0])
    {
        ...
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdGet'
            );
        }
     ...
     * @return void
     */
    public function infoGet($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['infoGet'][0])
    {
        $this->infoGetWithHttpInfo($x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    }
     ...
     */
    public function infoGetWithHttpInfo($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['infoGet'][0])
    {
        $request = $this->infoGetRequest($x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function infoGetAsync($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['infoGet'][0])
    {
        return $this->infoGetAsyncWithHttpInfo($x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function infoGetAsyncWithHttpInfo($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['infoGet'][0])
    {
        $returnType = '';
        $request = $this->infoGetRequest($x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function infoGetRequest($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['infoGet'][0])
    {
     ...
     * @return object
     */
    public function rootGet($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['rootGet'][0])
    {
        list($response) = $this->rootGetWithHttpInfo($x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function rootGetWithHttpInfo($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['rootGet'][0])
    {
        $request = $this->rootGetRequest($x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rootGetAsync($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['rootGet'][0])
    {
        return $this->rootGetAsyncWithHttpInfo($x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rootGetAsyncWithHttpInfo($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['rootGet'][0])
    {
        $returnType = 'object';
        $request = $this->rootGetRequest($x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function rootGetRequest($x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['rootGet'][0])
    {
