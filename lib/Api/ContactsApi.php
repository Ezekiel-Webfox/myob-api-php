...
/**
    ...
    /**
     * Operation companyFileIdContactGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdContactGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function companyFileIdContactGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdContactGet'][0])
    {
        list($response) = $this->companyFileIdContactGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdContactGetWithHttpInfo
     *
     * Fetch a list of all contacts
     *
     ...
     */
    public function companyFileIdContactGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdContactGet'][0])
    {
        $request = $this->companyFileIdContactGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Operation companyFileIdContactGetAsync
     *
     * Fetch a list of all contacts
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdContactGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdContactGet'][0])
    {
        return $this->companyFileIdContactGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdContactGetAsyncWithHttpInfo
     *
     * Fetch a list of all contacts
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdContactGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdContactGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdContactGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdContactGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (optional)
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function companyFileIdContactGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdContactGet'][0])
    {
        ...
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdContactGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Contact';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
