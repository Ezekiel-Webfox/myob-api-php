...
class InventoryApi
{
    ...
    public const contentTypes = [
        'companyFileIdInventoryLocationGet' => [
            'application/json',
        ],
    ];
...
/**
    ...
    /**
     * Operation companyFileIdInventoryLocationGet
     *
     * List all item locations
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdInventoryLocationGet'] to see the possible values for this operation
     *
     * @throws \Webfox\MYOB\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function companyFileIdInventoryLocationGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdInventoryLocationGet'][0])
    {
        list($response) = $this->companyFileIdInventoryLocationGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdInventoryLocationGetWithHttpInfo
     *
     * List all item locations
     *
     ...
     */
    public function companyFileIdInventoryLocationGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdInventoryLocationGet'][0])
    {
        $request = $this->companyFileIdInventoryLocationGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Operation companyFileIdInventoryLocationGetAsync
     *
     * List all item locations
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdInventoryLocationGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdInventoryLocationGet'][0])
    {
        return $this->companyFileIdInventoryLocationGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdInventoryLocationGetAsyncWithHttpInfo
     *
     * List all item locations
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdInventoryLocationGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdInventoryLocationGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdInventoryLocationGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdInventoryLocationGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (optional)
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function companyFileIdInventoryLocationGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdInventoryLocationGet'][0])
    {
        ...
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdInventoryLocationGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Inventory/Location';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
