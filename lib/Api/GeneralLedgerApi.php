...
/**
 * GeneralLedgerApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
/**
    ...
    /**
     * Operation companyFileIdGeneralLedgerCurrencyGet
     *
     * Currency
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdGeneralLedgerCurrencyGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function companyFileIdGeneralLedgerCurrencyGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGeneralLedgerCurrencyGet'][0])
    {
        list($response) = $this->companyFileIdGeneralLedgerCurrencyGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdGeneralLedgerCurrencyGetWithHttpInfo
     *
     * Currency
     *
     ...
     */
    public function companyFileIdGeneralLedgerCurrencyGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGeneralLedgerCurrencyGet'][0])
    {
        $request = $this->companyFileIdGeneralLedgerCurrencyGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Operation companyFileIdGeneralLedgerCurrencyGetAsync
     *
     * Currency
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdGeneralLedgerCurrencyGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGeneralLedgerCurrencyGet'][0])
    {
        return $this->companyFileIdGeneralLedgerCurrencyGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdGeneralLedgerCurrencyGetAsyncWithHttpInfo
     *
     * Currency
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdGeneralLedgerCurrencyGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGeneralLedgerCurrencyGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdGeneralLedgerCurrencyGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdGeneralLedgerCurrencyGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (optional)
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function companyFileIdGeneralLedgerCurrencyGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdGeneralLedgerCurrencyGet'][0])
    {
        ...
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdGeneralLedgerCurrencyGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/GeneralLedger/Currency';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
