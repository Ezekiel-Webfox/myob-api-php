...
/**
 * SalesInvoicesSaleQuotesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SalesInvoicesSaleQuotesApi
{
    /**
     * @var ClientInterface
     */
...
/**
    ...
    /**
     * Operation companyFileIdSaleQuoteGet
     *
     * List all the quotes
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdSaleQuoteGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function companyFileIdSaleQuoteGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleQuoteGet'][0])
    {
        list($response) = $this->companyFileIdSaleQuoteGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdSaleQuoteGetWithHttpInfo
     *
     * List all the quotes
     *
     ...
     */
    public function companyFileIdSaleQuoteGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleQuoteGet'][0])
    {
        $request = $this->companyFileIdSaleQuoteGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Operation companyFileIdSaleQuoteGetAsync
     *
     * List all the quotes
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdSaleQuoteGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleQuoteGet'][0])
    {
        return $this->companyFileIdSaleQuoteGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdSaleQuoteGetAsyncWithHttpInfo
     *
     * List all the quotes
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdSaleQuoteGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleQuoteGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdSaleQuoteGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdSaleQuoteGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (optional)
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function companyFileIdSaleQuoteGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleQuoteGet'][0])
    {
        ...
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdSaleQuoteGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Sale/Quote';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
