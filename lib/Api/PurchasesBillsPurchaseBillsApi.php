<?php
/**
 * PurchasesBillsPurchaseBillsApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PurchasesBillsPurchaseBillsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PurchasesBillsPurchaseBillsApi
{
    /**
     * @var ClientInterface
     */
    ...
    public const contentTypes = [
        'companyFileIdPurchaseBillGet' => [
            'application/json',
        ],
        'companyFileIdPurchaseBillTypeGuidGet' => [
            'application/json',
        ],
    ];
...
/**
    ...
    /**
     * Operation companyFileIdPurchaseBillGet
     *
     * List all the bills
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdPurchaseBillGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function companyFileIdPurchaseBillGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillGet'][0])
    {
        list($response) = $this->companyFileIdPurchaseBillGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdPurchaseBillGetWithHttpInfo
     *
     * List all the bills
     *
     ...
     */
    public function companyFileIdPurchaseBillGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillGet'][0])
    {
        $request = $this->companyFileIdPurchaseBillGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Operation companyFileIdPurchaseBillGetAsync
     *
     * List all the bills
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdPurchaseBillGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillGet'][0])
    {
        return $this->companyFileIdPurchaseBillGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdPurchaseBillGetAsyncWithHttpInfo
     *
     * List all the bills
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdPurchaseBillGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdPurchaseBillGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdPurchaseBillGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (optional)
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function companyFileIdPurchaseBillGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillGet'][0])
    {
        ...
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdPurchaseBillGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Purchase/Bill';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation companyFileIdPurchaseBillTypeGuidGet
     *
     * Render bill as PDF
     *
     * @param  string $company_file_id company_file_id (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdPurchaseBillTypeGuidGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string
     */
    public function companyFileIdPurchaseBillTypeGuidGet($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillTypeGuidGet'][0])
    {
        list($response) = $this->companyFileIdPurchaseBillTypeGuidGetWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdPurchaseBillTypeGuidGetWithHttpInfo
     *
     * Render bill as PDF
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdPurchaseBillTypeGuidGetWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillTypeGuidGet'][0])
    {
        $request = $this->companyFileIdPurchaseBillTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    ...
    /**
     * Operation companyFileIdPurchaseBillTypeGuidGetAsync
     *
     * Render bill as PDF
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdPurchaseBillTypeGuidGetAsync($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillTypeGuidGet'][0])
    {
        return $this->companyFileIdPurchaseBillTypeGuidGetAsyncWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdPurchaseBillTypeGuidGetAsyncWithHttpInfo
     *
     * Render bill as PDF
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdPurchaseBillTypeGuidGetAsyncWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillTypeGuidGet'][0])
    {
        $returnType = 'string';
        $request = $this->companyFileIdPurchaseBillTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdPurchaseBillTypeGuidGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $type (required)
     * @param  string $guid (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function companyFileIdPurchaseBillTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseBillTypeGuidGet'][0])
    {

        // verify the required parameter 'company_file_id' is set
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdPurchaseBillTypeGuidGet'
            );
        }
        ...
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type when calling companyFileIdPurchaseBillTypeGuidGet'
            );
        }
        ...
        if ($guid === null || (is_array($guid) && count($guid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $guid when calling companyFileIdPurchaseBillTypeGuidGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Purchase/Bill/{type}/{guid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
