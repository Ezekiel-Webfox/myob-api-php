<?php
/**
 * PurchasesBillsPurchaseOrderApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PurchasesBillsPurchaseOrderApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PurchasesBillsPurchaseOrderApi
{
    /**
     * @var ClientInterface
     */
...
/**
    ...
    /**
     * Operation companyFileIdPurchaseOrderGet
     *
     * List all the orders
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdPurchaseOrderGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function companyFileIdPurchaseOrderGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderGet'][0])
    {
        list($response) = $this->companyFileIdPurchaseOrderGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdPurchaseOrderGetWithHttpInfo
     *
     * List all the orders
     *
     ...
     */
    public function companyFileIdPurchaseOrderGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderGet'][0])
    {
        $request = $this->companyFileIdPurchaseOrderGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Operation companyFileIdPurchaseOrderGetAsync
     *
     * List all the orders
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdPurchaseOrderGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderGet'][0])
    {
        return $this->companyFileIdPurchaseOrderGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdPurchaseOrderGetAsyncWithHttpInfo
     *
     * List all the orders
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdPurchaseOrderGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdPurchaseOrderGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdPurchaseOrderGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (optional)
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function companyFileIdPurchaseOrderGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderGet'][0])
    {
        ...
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdPurchaseOrderGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Purchase/Order';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation companyFileIdPurchaseOrderTypeGuidGet
     *
     * Render order as PDF
     *
     * @param  string $company_file_id company_file_id (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdPurchaseOrderTypeGuidGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function companyFileIdPurchaseOrderTypeGuidGet($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderTypeGuidGet'][0])
    {
        $this->companyFileIdPurchaseOrderTypeGuidGetWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    }

    /**
     * Operation companyFileIdPurchaseOrderTypeGuidGetWithHttpInfo
     *
     * Render order as PDF
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdPurchaseOrderTypeGuidGetWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderTypeGuidGet'][0])
    {
        $request = $this->companyFileIdPurchaseOrderTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    ...
    /**
     * Operation companyFileIdPurchaseOrderTypeGuidGetAsync
     *
     * Render order as PDF
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdPurchaseOrderTypeGuidGetAsync($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderTypeGuidGet'][0])
    {
        return $this->companyFileIdPurchaseOrderTypeGuidGetAsyncWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdPurchaseOrderTypeGuidGetAsyncWithHttpInfo
     *
     * Render order as PDF
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdPurchaseOrderTypeGuidGetAsyncWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderTypeGuidGet'][0])
    {
        $returnType = '';
        $request = $this->companyFileIdPurchaseOrderTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdPurchaseOrderTypeGuidGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $type (required)
     * @param  string $guid (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function companyFileIdPurchaseOrderTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdPurchaseOrderTypeGuidGet'][0])
    {

        // verify the required parameter 'company_file_id' is set
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdPurchaseOrderTypeGuidGet'
            );
        }
        ...
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type when calling companyFileIdPurchaseOrderTypeGuidGet'
            );
        }
        ...
        if ($guid === null || (is_array($guid) && count($guid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $guid when calling companyFileIdPurchaseOrderTypeGuidGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Purchase/Order/{type}/{guid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
