...
/**
 * SalesInvoicesSaleOrderApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SalesInvoicesSaleOrderApi
{
    /**
     * @var ClientInterface
     */
...
/**
    ...
    /**
     * Operation companyFileIdSaleOrderGet
     *
     * List all the orders
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdSaleOrderGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function companyFileIdSaleOrderGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleOrderGet'][0])
    {
        list($response) = $this->companyFileIdSaleOrderGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdSaleOrderGetWithHttpInfo
     *
     * List all the orders
     *
     ...
     */
    public function companyFileIdSaleOrderGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleOrderGet'][0])
    {
        $request = $this->companyFileIdSaleOrderGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Operation companyFileIdSaleOrderGetAsync
     *
     * List all the orders
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdSaleOrderGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleOrderGet'][0])
    {
        return $this->companyFileIdSaleOrderGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdSaleOrderGetAsyncWithHttpInfo
     *
     * List all the orders
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdSaleOrderGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleOrderGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdSaleOrderGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdSaleOrderGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (optional)
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function companyFileIdSaleOrderGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleOrderGet'][0])
    {
        ...
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdSaleOrderGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Sale/Order';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation companyFileIdSaleOrderTypeGuidGet
     *
     * Render order as PDF
     *
     * @param  string $company_file_id company_file_id (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdSaleOrderTypeGuidGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function companyFileIdSaleOrderTypeGuidGet($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleOrderTypeGuidGet'][0])
    {
        $this->companyFileIdSaleOrderTypeGuidGetWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    }

    /**
     * Operation companyFileIdSaleOrderTypeGuidGetWithHttpInfo
     *
     * Render order as PDF
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdSaleOrderTypeGuidGetWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleOrderTypeGuidGet'][0])
    {
        $request = $this->companyFileIdSaleOrderTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    ...
    /**
     * Operation companyFileIdSaleOrderTypeGuidGetAsync
     *
     * Render order as PDF
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdSaleOrderTypeGuidGetAsync($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleOrderTypeGuidGet'][0])
    {
        return $this->companyFileIdSaleOrderTypeGuidGetAsyncWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdSaleOrderTypeGuidGetAsyncWithHttpInfo
     *
     * Render order as PDF
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdSaleOrderTypeGuidGetAsyncWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleOrderTypeGuidGet'][0])
    {
        $returnType = '';
        $request = $this->companyFileIdSaleOrderTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdSaleOrderTypeGuidGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $type (required)
     * @param  string $guid (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function companyFileIdSaleOrderTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleOrderTypeGuidGet'][0])
    {

        // verify the required parameter 'company_file_id' is set
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdSaleOrderTypeGuidGet'
            );
        }
        ...
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type when calling companyFileIdSaleOrderTypeGuidGet'
            );
        }
        ...
        if ($guid === null || (is_array($guid) && count($guid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $guid when calling companyFileIdSaleOrderTypeGuidGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Sale/Order/{type}/{guid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
