...
/**
 * SalesInvoicesSaleInvoicesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SalesInvoicesSaleInvoicesApi
{
    /**
     * @var ClientInterface
     */
...
/**
     ...
     * @return object
     */
    public function companyFileIdSaleInvoiceGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceGet'][0])
    {
        list($response) = $this->companyFileIdSaleInvoiceGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }
     ...
     */
    public function companyFileIdSaleInvoiceGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceGet'][0])
    {
        $request = $this->companyFileIdSaleInvoiceGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
     ...
     */
    public function companyFileIdSaleInvoiceGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceGet'][0])
    {
        return $this->companyFileIdSaleInvoiceGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdSaleInvoiceGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdSaleInvoiceGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
     ...
     */
    public function companyFileIdSaleInvoiceGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceGet'][0])
    {
    ...
    /**
     * Operation companyFileIdSaleInvoiceTypeGuidGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdSaleInvoiceTypeGuidGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function companyFileIdSaleInvoiceTypeGuidGet($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceTypeGuidGet'][0])
    {
        $this->companyFileIdSaleInvoiceTypeGuidGetWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    }

    /**
     * Operation companyFileIdSaleInvoiceTypeGuidGetWithHttpInfo
     *
     * Render invoice as PDF
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdSaleInvoiceTypeGuidGetWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceTypeGuidGet'][0])
    {
        $request = $this->companyFileIdSaleInvoiceTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    ...
    /**
     * Operation companyFileIdSaleInvoiceTypeGuidGetAsync
     *
     * Render invoice as PDF
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdSaleInvoiceTypeGuidGetAsync($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceTypeGuidGet'][0])
    {
        return $this->companyFileIdSaleInvoiceTypeGuidGetAsyncWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdSaleInvoiceTypeGuidGetAsyncWithHttpInfo
     *
     * Render invoice as PDF
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdSaleInvoiceTypeGuidGetAsyncWithHttpInfo($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceTypeGuidGet'][0])
    {
        $returnType = '';
        $request = $this->companyFileIdSaleInvoiceTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $accept, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdSaleInvoiceTypeGuidGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $type (required)
     * @param  string $guid (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function companyFileIdSaleInvoiceTypeGuidGetRequest($company_file_id, $type, $guid, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, $accept = null, string $contentType = self::contentTypes['companyFileIdSaleInvoiceTypeGuidGet'][0])
    {

        // verify the required parameter 'company_file_id' is set
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdSaleInvoiceTypeGuidGet'
            );
        }
        ...
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type when calling companyFileIdSaleInvoiceTypeGuidGet'
            );
        }
        ...
        if ($guid === null || (is_array($guid) && count($guid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $guid when calling companyFileIdSaleInvoiceTypeGuidGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Sale/Invoice/{type}/{guid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
