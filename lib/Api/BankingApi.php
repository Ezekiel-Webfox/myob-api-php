...
class BankingApi
{
    ...
    public const contentTypes = [
        'companyFileIdBankingStatementGet' => [
            'application/json',
        ],
    ];
...
/**
    ...
    /**
     * Operation companyFileIdBankingStatementGet
     *
     * Fetch the bank statements
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companyFileIdBankingStatementGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function companyFileIdBankingStatementGet($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdBankingStatementGet'][0])
    {
        list($response) = $this->companyFileIdBankingStatementGetWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
        return $response;
    }

    /**
     * Operation companyFileIdBankingStatementGetWithHttpInfo
     *
     * Fetch the bank statements
     *
     ...
     */
    public function companyFileIdBankingStatementGetWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdBankingStatementGet'][0])
    {
        $request = $this->companyFileIdBankingStatementGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Operation companyFileIdBankingStatementGetAsync
     *
     * Fetch the bank statements
     *
     * @param  string $company_file_id (required)
     ...
     */
    public function companyFileIdBankingStatementGetAsync($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdBankingStatementGet'][0])
    {
        return $this->companyFileIdBankingStatementGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation companyFileIdBankingStatementGetAsyncWithHttpInfo
     *
     * Fetch the bank statements
     *
     * @param  string $company_file_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companyFileIdBankingStatementGetAsyncWithHttpInfo($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdBankingStatementGet'][0])
    {
        $returnType = 'object';
        $request = $this->companyFileIdBankingStatementGetRequest($company_file_id, $x_myobapi_key, $x_myobapi_version, $accept_encoding, $contentType);
    ...
    /**
     * Create request for operation 'companyFileIdBankingStatementGet'
     *
     * @param  string $company_file_id (required)
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (optional)
     * @param  string $x_myobapi_version The version of the API, v2 is the current version (optional)
     ...
     */
    public function companyFileIdBankingStatementGetRequest($company_file_id, $x_myobapi_key = null, $x_myobapi_version = null, $accept_encoding = null, string $contentType = self::contentTypes['companyFileIdBankingStatementGet'][0])
    {
        ...
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling companyFileIdBankingStatementGet'
            );
        }
        ...
        $resourcePath = '/{company_file_id}/Banking/Statement';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
